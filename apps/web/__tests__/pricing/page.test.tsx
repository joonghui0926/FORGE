...
describe('PricingPage', () => {
  it('makes the $350 checkout path obvious and describes a data-only offer', () => {
    ...
    expect(screen.getByRole('heading', { name: /robot-ready data for \$350/i })).toBeInTheDocument()
    expect(screen.getByText(/dataset—not robot hardware/i)).toBeInTheDocument()
